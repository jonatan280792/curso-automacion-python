...
# Módulo 5: comportamiento clásico (sin abanico ni preflight del módulo 6)
ARRASTRE_ABANICO_ACTIVO = False
OCR_PREFLIGHT_ACTIVO = False
OCR_LECTURAS_INVALIDAS_ABORT = 0
