#!/usr/bin/env python3
"""Leer texto en el recorte de coordenadas (Tesseract + captura mss)."""
...
def recorte_ocr_en_pantalla() -> tuple[int, int, int, int] | None:
    """Rectángulo absoluto marcado en el modal (coordenadas del mapa)."""
...
def preparar_para_ocr(img: Image.Image) -> Image.Image:
    """Texto blanco sobre fondo oscuro → binario negro sobre blanco (mejor para Tesseract)."""
